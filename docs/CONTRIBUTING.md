...
We expect all contributors to follow our [`Code of Conduct`](https://github.com/aditya-ai00/weather/blob/main/docs/CODEOFCONDUCT.md).
...
- Take a look at the existing [Issues](https://github.com/aditya-ai00/weather/issues). 
- Fork the Repo & create a branch for any issue that you are working on and commit your work.
- At first raise an issue in which you want to work
- Then after assigning only then work on that issue & make a PR 
- Create a [**Pull Request**](https://github.com/aditya-ai00/weather/pulls), which will be promptly reviewed and given suggestions for improvements by the community.
