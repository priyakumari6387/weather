# Contributor Covenant Code of Conduct — weather NSoC'26
...
![Contributors](https://img.shields.io/github/contributors/aditya-ai00/weather?style=for-the-badge) 
...
Whether you are **contributing code, writing documentation, attending discussions, or representing weather**, you are expected to follow this Code of Conduct.  
...
This Code of Conduct is adapted from the [Contributor Covenant (v3.0)](https://www.contributor-covenant.org/version/3/0/code_of_conduct/), with modifications tailored for **weather under the Nexus Spring of Code (NSoC’26).**  
...
We thank every contributor, maintainer, and member for **making weather a safe, inclusive, and inspiring space.** ✨💡  
...
Let’s make **weather** a place where everyone feels welcome to **learn, contribute, and innovate.** 🍰🤖💡 
